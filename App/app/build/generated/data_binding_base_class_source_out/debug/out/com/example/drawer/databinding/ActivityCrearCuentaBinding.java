...
public final class ActivityCrearCuentaBinding implements ViewBinding {
  ...
  private ActivityCrearCuentaBinding(@NonNull ConstraintLayout rootView, @NonNull Button button2,
      ...
      @NonNull ImageView imageView4, @NonNull TextView textView, @NonNull TextView textView5) {
  ...
  public static ActivityCrearCuentaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCrearCuentaBinding((ConstraintLayout) rootView, button2,
          editTextTextPersonName, editTextTextPersonName2, editTextTextPersonName3,
          editTextTextPersonName4, imageView4, textView, textView5);
    }
