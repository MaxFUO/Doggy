...
public class fragmentoMostrarAnimal extends Fragment {
    ...
    public fragmentoMostrarAnimal() {
        // Required empty public constructor
    }
    public static fragmentoMostrarAnimal newInstance(String param1, String param2) {
        fragmentoMostrarAnimal fragment = new fragmentoMostrarAnimal();
